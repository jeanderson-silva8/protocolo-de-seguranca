...
### [`CONTEXT_ADDONS.md`](CONTEXT_ADDONS.md)

Adendos específicos por contexto. Use apenas as seções que se aplicam ao seu projeto:

- 🔌 **Seção A — WebSocket / Real-time**
- 📁 **Seção B — Upload de arquivos**
- 💳 **Seção C — Pagamento**
- 🏢 **Seção D — Multi-tenant / SaaS B2B**
- 🤖 **Seção E — Aplicações com IA / LLM**
- 📡 **Seção F — APIs públicas / Webhooks**
- 📱 **Seção G — Mobile**
- 🧪 **Seção H — Projetos com dados sensíveis (saúde, financeiro, jurídico)**
- 📨 **Seção I — Filas / Workers / Mensageria**
- 🔍 **Seção J — GraphQL**
...
A prova de que os checklists funcionam está em aplicá-los. Dois relatórios completos disponíveis:
